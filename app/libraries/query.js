...
const wallet = new FileSystemWallet(__dirname + '/local_fabric/wallet');
...
async function main() {
  ...
  try {
    ...
    let response = await contract.evaluateTransaction('transaction1', 'GREETING');
...
async function createCar(car) {
  ...
  try {
    ...
    let response = await contract.submitTransaction('createCar', car.id, car.color, car.manufacturer, car.owner);
...
async function findCar(id) {
  ...
  try {
    ...
    let response = await contract.evaluateTransaction('findCar', id);
